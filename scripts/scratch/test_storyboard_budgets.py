...
GT_MOMENTS = {
    ...
    "9月15日": [
        (33.72, 39.84, "拉兄弟进场（白门老铁）"),
        (62.85, 70.97, "北冥有鱼犟嘴互怼"),
        (128.32, 131.84, "祭白组合/太祭白了"),
        (146.48, 149.72, "拼一下这把发微信"),
        (206.25, 211.21, "鱼电商在不在"),
        (337.24, 346.02, "男不男女不女的/感谢刘默默"),
        (406.39, 411.55, "荣一鸣一分不许上/资本替你投"),
    ],
}
